...
imshow(binaryImage); subplot(2,1,1), imshow(im); subplot(2,1,2), imshow(binaryImage);
...
for k = 1 : numberOfBlobs           % Loop through all blobs.
	...
	meanGL = mean(im(thisBlobsPixels)); % Find mean intensity (in original image!)
